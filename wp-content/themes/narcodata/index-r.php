	...
	<div class="row">
		<div class="col12">
			...
			<div class="sectionListItem">
				...
				<a href="http://narcodata.animalpolitico.com/lucha-contra-las-drogas/">
						<div class="sectionItem-wrap">
							<div class="sectionItem-body">
								<div class="row-table">
									<div class="row-cell middle">
										...
										<div class="sectionItem-photo">
											<figure>
												<img src="<?php bloginfo('template_url'); ?>/assets/images/07_LP_ND.png" />
											</figure>
										</div>
										<h2>El poder de fuego del narco desafía al Estado</h2>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="sectionListItem sectionListItem--3">
				...
				<div class="sectionItem sectionItem--display">
					<a href="http://narcodata.animalpolitico.com/rivalidad-entre-carteles/">
						<div class="sectionItem-wrap">
							<div class="sectionItem-body">
								<div class="row-table">
									<div class="row-cell middle">
